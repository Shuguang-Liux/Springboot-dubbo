...
public class VehicleOwnerController {
    ...
    public ResultVo<?> insertVehicleOwner(@RequestBody VehicleOwnerEntity vehicleOwnerEntity){
        return vehicleOwnerService.insertVehicleOwnerAndPayment(vehicleOwnerEntity);
    }
    ...
    public void exportVehicleOwner(HttpServletResponse response, @RequestBody VehicleOwnerEntity vehicleOwnerEntity) {
        ResultVo<Boolean> resultVo = new ResultVo<>();
        try {
            ResultVo<Map<String, Object>> vehicleOwnerVo = vehicleOwnerService.exportVehicleOwner(vehicleOwnerEntity);
